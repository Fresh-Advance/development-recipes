...
$SCRIPT_PATH/../parts/shared/require.sh -n"fresh-advance/sitemap" -g"https://github.com/Fresh-Advance/Sitemap.git" -v"dev-b-7.0.x"
...
perl -pi\
  -e 's#</component>#<mapping directory="\$PROJECT_DIR\$/source/vendor/fresh-advance/sitemap" vcs="Git" />\n  </component>#g;'\
  .idea/vcs.xml